...
if(isset($_POST['submit'])){
    ...
    $total_product = filter_var($total_product, FILTER_SANITIZE_STRING);
    ...
    if($check_cart->rowCount() > 0){
        ...
        if($address == ''){
            ...
            $insert_order->execute([$user_id, $name, $number, $email, $method, $address, $total_product, $total_price]);
...
<section class="checkout">
    ...
    <form action="" method="post">
        ...
        <div class="user-info">
            ...
            <input type="submit" value="place order" class="btn <?php if($fetch_profile['address'] == ''){echo 'disabled'; }?>" name="submit" style="background-color: var(--red); width:100%; color:var(--white);">
